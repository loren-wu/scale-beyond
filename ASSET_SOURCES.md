...
This project uses NASA imagery for Earth, the Moon, and the Milky Way plane. The files are vendored at web-friendly resolutions so the experience does not depend on third-party servers at runtime. Where practical, original NASA URLs remain configured as a secondary fallback, followed by procedural textures.
...
The GLIMPSE 360 runtime panorama is credited to **NASA/JPL-Caltech/GLIMPSE Team**. Six 3000 × 500 public survey panels were joined in Galactic-longitude order and resized to a 4096 × 114 WebP without cropping the coverage gaps.
